        ...
        await slugs.map((slug) => {
            axios
                ...
                .then(function (response) {
                    ...
                    const result = { opensea: res.collection };
                    osData.push(result);
                    // console.log(result);
                });
        });
                    ...
                    <div className="INFO lg:flex items-center justify-center mt-2 container mx-auto">
                        ...
                        <div className="ml-5">
                            ...
                            <p className="text-xl font-semibold mb-8 leading-relaxed">
                                One of the DAO members will purchase the NFT
                                that come as a quick sale with randomly.
                            </p>
                        </div>
                    </div>
                </section>
                                ...
                                defendaoData.map((daoList, i) => (
                                    ...
                                    >
                                        ...
                                        <div className="col-span-3 sm:col-span-1 flex justify-center items-center">
                                            <>
                                                {osCollection.map((meta, i) => {
                                                    daoList.slug === meta.opensea.imgae_url ? (
                                                        <>
                                                            <Image
                                                                src={ osCollection.opensea.imgae_url }
                                                                width={60}
                                                                height={60}
                                                                unoptimized="true"
                                                                alt="CollectionImg"
