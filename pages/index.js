                    ...
                    <>
                        <div className="container mx-auto px-8 -mt-3 h-screen">
                            <div className="grid grid-cols-10 font-semibold text-center bg-slate-200 dark:bg-slate-700 p-2 rounded-t-xl">
                                ...
                                <div className="col-span-3 hidden sm:block">CollectionName</div>
                            ...
                            {loading ? (
                                ...
                                defendaoData.map((daoList, i) => (
                                    <div
                                        className="relative grid grid-cols-10 py-4 p-2 border-b text-center border-b-slate-500 bg-slate-100 dark:bg-slate-900 bg-opacity-20 group"
                                        key={daoList.i}
